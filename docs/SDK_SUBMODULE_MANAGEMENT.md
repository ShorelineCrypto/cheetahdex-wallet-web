...
This document provides guidance on working with the Komodo DeFi SDK Flutter submodule in the Cheetahdex Wallet project.

## Overview

The Cheetahdex Wallet project uses the komodo-defi-sdk-flutter repository as a git submodule located in the `sdk/` directory. This allows us to:
